...
const UserInfoBar = ({ 
  ...
  const annualBalance2025 = useMemo(() => {
    ...
    const rawEntry = annualBalances.find(b => 
      Number(b.userId || b.user_id) === Number(currentUser.id) && 
      Number(b.cycle_start_year || b.year) === 2025
    );
            ...
            <div className="flex-1 md:flex-initial">
              <div className="grid grid-cols-3 gap-3 xs:gap-2">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xl xs:text-lg font-bold text-blue-600">{displayUsedDays}</p>
                </div>
                <div className="text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 xs:gap-2">
            {Object.entries(LEAVE_TYPES)
              ...
              .map(([type, info]) => {
                ...
                return (
                  <div key={type} className="p-3 xs:p-2 rounded-lg border hover:shadow-md transition-shadow bg-gray-50/30">
